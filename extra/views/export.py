# MRWF - extra/public/views/export.py
#
    ...
    if fmt == 'csv':
        ...
        for e in events:
            ...
            try:
                ...
                mc_stall = stall.mc_stall_option_str
                plot_type = stall.plot_type_str
            ...
            csv.write((e.name, e.status_str, e.description,
                       ...
                       n_spaces, n_tables, mc_stall, plot_type))
